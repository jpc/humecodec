...
PYBIND11_MODULE(_humecodec, m) {
  ...
  py::class_<StreamingMediaDecoder>(
      ...
      .def("add_seek_points", &StreamingMediaDecoder::add_seek_points)
  ...
  py::class_<StreamingMediaDecoderFileObj>(
      ...
      .def("add_seek_points", &StreamingMediaDecoderFileObj::add_seek_points)
  ...
  py::class_<StreamingMediaDecoderBytes>(
      ...
      .def("add_seek_points", &StreamingMediaDecoderBytes::add_seek_points)
